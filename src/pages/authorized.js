...
import uni from '../pdf/uniform_ordersheet.pdf'
            ...
            <div id="main">
                <div className="inner">
                    <div className="content">
                        ...
                        <ul className="actions">
                            <li><a href={uni} className="button special rounded fit icon fa-file-pdf-o" target="_blank" rel="noopener noreferrer">ユニホーム購入申込書</a></li>
                        </ul>
