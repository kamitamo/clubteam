                ...
                <section id="one">
                    <div className="inner">
                        ...
                        <ul className="actions">
                            <li><Link to="/journal"><u>07/29-30の試合結果</u>を更新しました</Link></li><br/>
                            <li><Link to="/journal"><u>07/22-23の試合結果</u>を更新しました</Link></li><br/>
                            <li><Link to="/journal"><u>07/16-17の試合結果</u>を更新しました</Link></li><br/>
                        </ul>
                    </div>
                </section>
