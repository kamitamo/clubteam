                ...
                <section id="one">
                    <div className="inner">
                        ...
                        <ul className="actions">
                            <li><Link to="/journal"><u>01/09の試合結果</u>を更新しました</Link></li><br/>
                            <li><Link to="/journal"><u>01/06の試合結果</u>を更新しました</Link></li><br/>
                            <li><Link to="/syokuiku-Seminer"><u>小学生親子向け食育セミナー</u>を開催予定</Link></li><br/>
                        </ul>
                    </div>
                </section>
