                ...
                <section id="one">
                    <div className="inner">
                        ...
                        <ul className="actions">
                            <li><Link to="/journal"><u>7/30, 7/31の試合結果</u>を更新しました</Link></li><br/>
                            <li><Link to="/journal"><u>7/25の試合結果</u>を更新しました</Link></li><br/>
                            <li><Link to="/journal"><u>7/23、7/24の試合結果</u>を更新しました</Link></li><br/>
                        </ul>
                    </div>
                </section>
